const techRelations = {
  javascript: ["typescript", "nodejs", "react", "nextjs"],
  typescript: ["javascript", "react", "nodejs", "nestjs", "prisma", "expo"],
  python: ["fastapi", "sqlalchemy"],
  java: [],
  cpp: [],
  sql: ["postgresql", "mariadb", "sqlalchemy", "prisma"],
  react: ["typescript", "nodejs", "nextjs", "expo", "fastapi", "postgresql"],
  nextjs: ["react", "typescript"],
  expo: ["react", "typescript", "nodejs"],
  nodejs: ["javascript", "typescript", "expressjs", "nestjs", "postgresql"],
  expressjs: ["nodejs", "javascript", "typescript", "postgresql"],
  ...
  postgresql: ["sql", "nodejs", "fastapi", "nestjs", "prisma", "sqlalchemy", "expressjs"],
  mariadb: ["sql"],
  git: ["github"],
  github: ["git", "cicd"],
  aws: ["cicd"],
...
if (stackEl && !window.matchMedia("(prefers-reduced-motion: reduce)").matches) {
  ...
  stackEl.addEventListener("mouseenter", (e) => {
  ...
  stackEl.addEventListener("mouseleave", (e) => {
    const pill = e.target.closest(".pill[data-tech]");
    if (!pill) return;
